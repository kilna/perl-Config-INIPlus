...
sub _debug
{
	...
	print STDERR __PACKAGE__ . " Line " . $fh->input_line_number . ' '
	  . $message . "\n";
}
...
sub _error
{
	...
	$message .= " at input line " . $fh->input_line_number . " '".$line."'";
